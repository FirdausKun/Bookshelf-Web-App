...
const addBook = () => {
  ...
  if (update == "none") {
    ...
    document.getElementById("update").value = "none";
  } else {
...
function editBook(bookId) {
  ...
  document.getElementById("update").value = bookTarget.id;
  ...
  document.getElementById("isComplete").value = bookTarget.isComplete;
...
document.addEventListener("RENDER_EVENT", () => {
  ...
  const parentCompleted = document.querySelector(
    ".parent-card-books-completed"
  );
...
const cardUnCompleted = (e) => {
  ...
  editButton.classList.add("btn-green2");
